...
namespace Plugify
{
	...
	public class Plugin : IEquatable<Plugin>, IComparable<Plugin>
	{
		...
		internal Plugin(long id, string name, string fullName, string description, string version, string author, string website, string baseDir, string[] dependencies)
		{
			Id = id;
			Name = name;
			FullName = fullName;
		...
		{
			return InternalCalls.Plugin_FindResource(Id, path);
		}
